...
const galleryCaptions = {
  en: {
    ...
    "urban-candid": "Candid",
    "singer-arm-up-blue": "Arm up",
    "guitarist-leather-vertical": "Leather cut",
    "singer-profile-red-led": "Red LED",
    "singer-neon-mic-close": "Neon mic",
    "duo-bass-vocals": "Bass & voice",
    "singer-arms-wide-fuel": "Arms wide",
    "beto-bass-spotlight": "Beto spotlight",
    "explorer-guitar-dutch": "Dutch guitar",
    "duo-singer-guitar-fuel": "Two-man fuel",
    "drummer-pearl-led": "Pearl kit",
    "bass-guitar-interaction": "Low end",
    "fist-raise-duo": "Fist up",
    "trio-wide-fuel-logo": "Trio",
    "singer-fuel-intensity": "Intensity",
  },
  es: {
    ...
    "singer-arm-up-blue": "Brazo arriba",
    "guitarist-leather-vertical": "Cuero vertical",
    "singer-profile-red-led": "LED rojo",
    "singer-neon-mic-close": "Micrófono neón",
    "duo-bass-vocals": "Bajo y voz",
    "singer-arms-wide-fuel": "Brazos abiertos",
    "beto-bass-spotlight": "Beto al foco",
    "explorer-guitar-dutch": "Guitarra dutch",
    "duo-singer-guitar-fuel": "Dúo a fuego",
    "drummer-pearl-led": "Pearl",
    "bass-guitar-interaction": "Low end",
    "fist-raise-duo": "Puño arriba",
    "trio-wide-fuel-logo": "Trío",
    "singer-fuel-intensity": "Intensidad",
  },
